...
final class ProfileViewController: UIViewController, ProfileViewInput, StoryboardInitializable {
    ...
    func configureTableView() {
        ...
        tableView.register(nibModels: [ProfileCommonInfoViewModel.self, ProfileInfoViewModel.self])
    }
...
extension ProfileViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        switch type {
        case .common:
            return tableView.dequeueReusableCell(withModel: ProfileCommonInfoViewModel(), for: indexPath)
        case .info:
            return tableView.dequeueReusableCell(withModel: ProfileInfoViewModel(), for: indexPath)
        }
    }
}
