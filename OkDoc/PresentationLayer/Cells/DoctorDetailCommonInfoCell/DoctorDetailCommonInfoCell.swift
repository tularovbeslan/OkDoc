//
//  DoctorDetailCommonInfoCell.swift
//  OkDoc
//
...
class DoctorDetailCommonInfoCell: UITableViewCell {
...
extension DoctorDetailCommonInfoCell {
    func setup(viewModel: DoctorDetailCommonInfoViewModel) {
